...
export default function SignUpScreen() {
  ...
  const onVerifyPress = async () => {
    if (!isLoaded) return;
    if (!code) {
      Alert.alert("Error", "Please fill the verification code ");
      return;
    }
          ...
          <View className="flex-1 mx-6">
            <View className="flex-1 justify-center">
              ...
              <View className="items-center mb-8">
                ...
                <Text className="text-lg font-bold text-gray-500 text-center">
                  we've sent a emial verification code to{"\n"} {emailAddress}
                </Text>
              </View>
              {/* verification code  */}
        ...
        <View className="flex-1 mx-6">
          ...
          <View className="pb-6">
            <Text className="text-center text-gray-500 text-sm">
              Ready to ransform your fitness?
            </Text>
          </View>
        </View>
      </KeyboardAvoidingView>
